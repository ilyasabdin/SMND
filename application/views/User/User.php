        ...
        <!-- <div class="card-columns">
          <div class="card bg-primary">
            <div class="card-body text-center">
              <p class="card-text" style="color: white;">Agenda Akan Datang </p>
            </div>  
          </div>
          
          <div class="card bg-success">
            <div class="card-body text-center">
              <p class="card-text" style="color: white;">Notula Terarsip</p>
            </div>
          </div>
        </div>
 -->
          ...
          <div style="background-color: DodgerBlue; color: white;" class="card shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs text-left font-weight-bold  text-uppercase mb-1">
                    <a style="color: white" href="<?php echo base_url('Agenda_C') ?>">Total Agenda</a> 
                  </div>
                  <div class="col-auto">
                    <i class="fas fa-calendar fa-2x" style="text-align: center;">
                      <a style="color: white" href="<?php echo base_url('Agenda_C/index') ?>"><?php 
                      echo $total
                      ?></a>
                    </i>
                  </div>
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <a style="color: white" href="<?php echo base_url('Notula_C') ?>">Total Notula Terarsip</a>
                  </div>
                  <div class="col-auto">
                    <i class="fas fa-calendar-check fa-2x" style="text-align: center;"> 
                      <a style="color: white" href="<?php echo base_url('Notula_C') ?>"><?php 
                      echo $totaln
                      ?></a>
                    </i>
                  </div>
